...
├── /src/
│   lattice_sim.py            # Code for the 64-sector state-space
├── /data/
│   └── /calibration/            # Parameters for the Manna Protocol
└── README.md

The Mathematical foundation preamble.tex that can handle advanced quantum notation (the Hamiltonian), topological diagrams (the 64-sector lattice), and the code snippets to bridge the theory to the src/lattice_sim.py  directory.
